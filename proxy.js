...
.trend-wrap{background:#1e293b;border:1px solid #334155;border-radius:8px;padding:clamp(8px,1.5vw,12px);margin-bottom:12px}
...
function renderTrend(){
  ...
  labels.innerHTML=keys.map(k=>'<div class="trend-label">'+k.slice(-5).replace("-",":")+'</div>').join("");
